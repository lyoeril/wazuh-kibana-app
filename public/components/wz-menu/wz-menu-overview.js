...
class WzMenuOverview extends Component {
  constructor(props) {
    ...
    this.overviewSections = {
      ...
      ad: { id: WAZUH_MODULES_ID.AD, text: 'Active Directory'},
      threat: { id: WAZUH_MODULES_ID.THREAT, text: 'Network Threats' },
      firewall: { id: WAZUH_MODULES_ID.FIREWALL, text: 'Firewall' },
      office365: { id: WAZUH_MODULES_ID.OFFICE365, text: 'Office365' },
      command: { id: WAZUH_MODULES_ID.COMMAND, text: 'Command and Control' },
      sentinelone: { id: WAZUH_MODULES_ID.SENTINELONE, text: 'SentinelOne' }
    };
